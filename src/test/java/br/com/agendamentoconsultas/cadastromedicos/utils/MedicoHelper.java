package br.com.agendamentoconsultas.cadastromedicos.utils;
...
public class MedicoHelper {
    ...
    public static MedicoEntity gerarNovoMedicoEntityComHorarios() {
        ...
        List<HorarioTrabalhoEntity> horariosEntityList = new ArrayList<>();

        HorarioTrabalhoEntity horario = new HorarioTrabalhoEntity();
        horario.setDiaDaSemana(DiaDaSemanaEnum.SEXTA);
        horario.setHoraInicio(LocalTime.of(14, 0));
        horario.setHoraFim(LocalTime.of(19, 0));
    ...
    public static MedicoEntity gerarMedicoEntityExistenteComHorarios(){
        ...
        HorarioTrabalhoEntity horario1 = new HorarioTrabalhoEntity();
        ...
        HorarioTrabalhoEntity horario2 = new HorarioTrabalhoEntity();
    ...
    public static ArrayList<MedicoEntity> gerarListaMedicosEntityExistentesComHorarios(){
        ...
        List<HorarioTrabalhoEntity> horariosEntityList1 = new ArrayList<>();
        HorarioTrabalhoEntity horario1 = new HorarioTrabalhoEntity();
        horario1.setDiaDaSemana(DiaDaSemanaEnum.SEGUNDA);
        horario1.setHoraInicio(LocalTime.of(8, 0));
        horario1.setHoraFim(LocalTime.of(13, 0));
        ...
        List<HorarioTrabalhoEntity> horariosEntityList2 = new ArrayList<>();
        HorarioTrabalhoEntity horario3 = new HorarioTrabalhoEntity();
        ...
        List<HorarioTrabalhoEntity> horariosEntityList3 = new ArrayList<>();
        HorarioTrabalhoEntity horario4 = new HorarioTrabalhoEntity();
        ...
        HorarioTrabalhoEntity horario5 = new HorarioTrabalhoEntity();
